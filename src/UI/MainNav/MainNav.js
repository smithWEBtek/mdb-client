			...
			<Container>
				<Navbar className="MainNav" light expand="md">
					<Collapse isOpen={this.state.isOpen} navbar>
						<Nav navbar>
							<Link to='/tunes' className="Item">tunes</Link>
				...
				<div>
					<Route path="/" exact render={() => (
						<div>
							...
							<div>
								<h4>This app allows Teachers and Tunes to: </h4>
								<ul>
									<li>
									...
									<li>
										Create Retrieve Update and Delete:  Teacher, Tune, Resource, Lesson
                </li>
									<li>
										Toggle active / inactive for Teacher or Tune
                  </li>
								</ul>
