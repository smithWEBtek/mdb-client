			...
			return (
				<tr key={index}>
					...
					<td><Link
						...
						key={lesres.id}>{lesres.lesson.teacher.lastname} ~ {lesres.lesson.tune.lastname}</Link></td>
					<td><Link to={`/teachers/${lesres.lesson.teacher_id}`}>{lesres.lesson.teacher.firstname} {lesres.lesson.teacher.lastname}</Link></td>
					<td><Link to={`/tunes/${lesres.lesson.tune_id}`}>{lesres.lesson.tune.firstname} {lesres.lesson.tune.lastname}</Link></td>
